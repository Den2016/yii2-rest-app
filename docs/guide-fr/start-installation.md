...
4. Définissez la racine du document de votre serveur Web :
   ...
   - pour l'interface d'administration (api) `/path/to/yii-application/api/web/`, en utilisant URL `http://api.test/`
...
* pour l'interface d'administration : http://y2aa-api.test
